...
namespace K2Field.SmartObjects.Services.ES
{
    public class ServiceBroker : ServiceAssemblyBase
    {
        ...
        {
            base.Service.Name = "EventStoreService";
            base.Service.MetaData.DisplayName = "Event Store Service";
            base.Service.MetaData.Description = "Event Store Service";
        ...
        public override string GetConfigSection()
        {
            ...
            //Service.ServiceConfiguration.Add(StringResources.ExceptionOnEmptyResult, true, false);
